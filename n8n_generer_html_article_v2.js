...
// ATTENTION : lit depuis "🔗 Maillage inter-articles" (pas plus "📝 Parser réponse")
const parsed = $('🔗 Maillage inter-articles').first().json;
const imageUrl = (() => {
  try {
...
html += '<a href="/">Accueil</a><a href="/formation-ia-entreprise.html">Formations IA</a><a href="/apropos.html">À propos</a><a href="/blog.html">Blog</a>';
...
html += '<a href="/formation-ia-entreprise.html" class="btn-cta btn-primary">Voir les formations IA</a>';
...
html += '<a href="/formation-ia-entreprise.html">Voir les formations IA</a>';
...
html += '<a href="/formation-ia-entreprise.html" style="display:block;text-align:center;padding:9px 16px;border-radius:50px;font-size:0.82rem;font-weight:700;color:var(--primary);border:1.5px solid rgba(26,60,255,0.2);background:rgba(26,60,255,0.04);">En savoir plus</a>';
html += '</div>';
html += tagsHtml;
html += '</aside>';
html += '</div>';
...
html += '<a href="/formation-ia-entreprise.html" style="font-size:0.8rem;color:var(--muted);">Formations IA</a>';
